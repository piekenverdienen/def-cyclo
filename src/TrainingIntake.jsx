...
export default function TrainingIntake({ onComplete }) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-purple-700 via-purple-900 to-black text-white">
      <form
        onSubmit={handleSubmit}
        className="bg-white bg-opacity-90 p-8 rounded shadow-md w-full max-w-md space-y-6 text-gray-800"
      >
        <h1 className="text-3xl font-bold text-center text-purple-700">Gratis 6 Weken Trainingsschema</h1>
        <p className="text-center text-sm text-gray-600">
          Vul je gegevens in en ontvang een gepolariseerd schema afgestemd op jouw FTP en beschikbare tijd.
        </p>
