...
export default function TrainingIntake({ onComplete }) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-purple-700 to-black p-4">
      <form
        onSubmit={handleSubmit}
        className="bg-white p-8 rounded shadow-md w-full max-w-md space-y-6"
      >
        <h1 className="text-2xl font-bold text-center text-gray-800">Gratis 6 Weken Trainingsschema</h1>
        <p className="text-center text-gray-600">Ontvang direct een gepersonaliseerd schema door je gegevens in te vullen.</p>
